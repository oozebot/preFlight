...
#include "luminary/core/diagnostics/DebugOutput.hpp" // dbg_log / DBG_PERIMETERS
...
void SkeletalTrapezoidation::constructFromPolygons(const Polygons &polys)
{
    ...
    if (dropped_vertices > 0 || dropped_polys > 0)
        dbg_log(Luminary::DBG_PERIMETERS, 0., "SKEL", "CLEAN dropped_vertices=%zu dropped_polys=%zu", dropped_vertices,
                dropped_polys);
    ...
    if (has_missing_twin())
    {
        ...
        if (voronoi_diagram.get_state() != VD::State::REPAIR_UNSUCCESSFUL)
        {
            ...
            for (const double fix_angle : fix_angles)
            {
                ...
                dbg_log(Luminary::DBG_PERIMETERS, 0., "SKEL", "TWIN_REPAIR angle=%.4f issue=%d accepted=%d", fix_angle,
        ...
        {
            dbg_log(Luminary::DBG_PERIMETERS, 0., "SKEL",
        ...
        if (!repaired)
        {
            ...
            dbg_log(Luminary::DBG_PERIMETERS, 0., "SKEL", "TWIN_GIVEUP polys=%zu area_mm2=%.3f", clean_polys.size(),
