                            ...
                            const Flow &flow, const uint32_t perimeter_index)
{
    for (const ClipperZUtils::ZPath &extrusion_path : extrusion_paths)
    {
        ...
        Luminary::append(dst, PerimeterGenerator::thick_polyline_to_multi_path(thick_polyline, role, flow,
                                                                               scaled<float>(0.05),
                            ...
                            const Flow &flow, const uint32_t perimeter_index)
{
    ...
    ExtrusionMultiPath multi_path = PerimeterGenerator::thick_polyline_to_multi_path(thick_polyline, role, flow,
                                                                                     scaled<float>(0.05),
                                                                                     float(SCALED_EPSILON),
                                                                                     perimeter_index);
    Luminary::append(dst, multi_path.paths);
}
} // namespace Luminary