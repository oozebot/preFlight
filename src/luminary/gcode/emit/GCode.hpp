...
///|/
#pragma once
#include "luminary/gcode/emit/order/ExtrusionOrder.hpp"
#include "luminary/analysis/extrusion_annotation/ExtrusionProcessor.hpp"
#include "luminary/gcode/emit/travel/JumpPointSearch.hpp"
...
#include "luminary/gcode/emit/travel/AvoidCrossingPerimeters.hpp"
#include "luminary/gcode/filters/CoolingBuffer.hpp"
#include "luminary/gcode/filters/FindReplace.hpp"
#include "luminary/gcode/writer/GCodeWriter.hpp"
#include "LabelObjects.hpp"
#include "luminary/gcode/filters/PressureEqualizer.hpp"
#include "luminary/gcode/emit/travel/RetractWhenCrossingPerimeters.hpp"
#include "luminary/gcode/emit/path/SmoothPath.hpp"
#include "luminary/gcode/filters/SpiralVase.hpp"
#include "luminary/layer/tool_ordering/ToolOrdering.hpp"
#include "luminary/gcode/emit/path/Wipe.hpp"
#include "luminary/gcode/wipe_tower/WipeTowerIntegration.hpp"
#include "luminary/gcode/seams/SeamPlacer.hpp"
...
private:
    ...
    public:
        ...
        // Defined where GCodeObject is complete, so the delete runs its destructor.
        ~GCodeOutputStream();
    ...
    // Build every object layer's role index in parallel before the export pipelines, when a
    // region can query them.
    void prebuild_role_indexes(const Print &print);
    ...
    // The paths are decimated to the owning object's G-code resolution, or interpolated with
    // circular arches when the print asks for them.
    static void smooth_path_interpolate(const ObjectLayerToPrint &layers, const PrintConfig &print_config,
