...
#include "luminary/geometry/contours/Polyline.hpp" // For ThickPolyline
...
{
    // Calculate the cross product (a-b) x (c-b), which gives twice the signed area of triangle abc
