...
class FlowError : public Luminary::InvalidArgument
{
public:
    FlowError(const std::string &what_arg) : Luminary::InvalidArgument(what_arg) {}
    FlowError(const char *what_arg) : Luminary::InvalidArgument(what_arg) {}
};
