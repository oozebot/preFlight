                                     ...
                                     ConfigSubstitutionContext &substitutions_ctxt, bool append)
{
    ...
    {
        // Vectors of bools substitute per element, so one bad element falls back to the option default
...
{
    // Every key is exported under the documented PREFLIGHT_ prefix and under the SLIC3R_ twin, so
    // post-processing scripts written against the old names keep working.
    static const char *const prefixes[] = {"PREFLIGHT_", "SLIC3R_"};
    t_config_option_keys opt_keys = this->keys();
    for (t_config_option_keys::const_iterator it = opt_keys.begin(); it != opt_keys.end(); ++it)
    {
        const std::string value = this->opt_serialize(*it);
        for (const char *prefix : prefixes)
        {
            std::string envname = prefix + *it;

            // capitalize environment variable name
            for (size_t i = 0; i < envname.size(); ++i)
                envname[i] = (envname[i] <= 'z' && envname[i] >= 'a') ? envname[i] - ('a' - 'A') : envname[i];

            boost::nowide::setenv(envname.c_str(), value.c_str(), 1);
        }
    }
}
                                     ...
                                     ForwardCompatibilitySubstitutionRule compatibility_rule)
{
    ...
    default:
    {
        throw Luminary::RuntimeError(format("Invalid file %1%", filename));
    }
    }
}
                                                     ...
                                                     ForwardCompatibilitySubstitutionRule compatibility_rule)
{
    ...
    {
        static constexpr const char gcode_header[] = "; generated by Slic3r ";
        ...
        {
            if (strncmp(gcode_header, header.c_str(), strlen(gcode_header)) == 0)
            {
                header_found = true;
                break;
            }
        ...
        if (!header_found)
            throw Luminary::RuntimeError("No preFlight configuration was found in this G-code.");
    }
                                                            ...
                                                            ForwardCompatibilitySubstitutionRule compatibility_rule)
{
    ...
    if (res != EResult::Success)
        throw Luminary::RuntimeError(format("File %1% does not contain a valid binary gcode\nError: %2%", filename,
    ...
    if ((EBlockType) block_header.type != EBlockType::SlicerMetadata)
        throw Luminary::RuntimeError(format("Unable to find slicer metadata block in file %1%", filename));
...
void ConfigBase::save(const std::string &file) const
{
    ...
    c << "# " << Luminary::header_generated() << std::endl;
...
CEREAL_REGISTER_TYPE(Luminary::ConfigOption)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionSingle<double>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionSingle<int>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionSingle<std::string>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionSingle<Luminary::Vec2d>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionSingle<Luminary::Vec3d>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionSingle<bool>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionSingleNullable<double>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionSingleNullable<int>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionSingleNullable<bool>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionVectorBase)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionVector<double>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionVector<int>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionVector<std::string>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionVector<Luminary::Vec2d>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionVector<unsigned char>)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionFloat)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionFloatNullable)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionFloats)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionFloatsNullable)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionInt)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionIntNullable)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionInts)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionIntsNullable)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionString)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionStrings)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionPercent)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionPercents)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionPercentsNullable)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionFloatOrPercent)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionFloatsOrPercents)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionFloatsOrPercentsNullable)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionPoint)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionPoints)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionPoint3)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionBool)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionBools)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionBoolsNullable)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionEnumGeneric)
CEREAL_REGISTER_TYPE(Luminary::ConfigOptionEnumsGeneric)
CEREAL_REGISTER_TYPE(Luminary::ConfigBase)
CEREAL_REGISTER_TYPE(Luminary::DynamicConfig)

CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOption, Luminary::ConfigOptionSingle<double>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOption, Luminary::ConfigOptionSingle<int>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOption, Luminary::ConfigOptionSingle<std::string>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOption, Luminary::ConfigOptionSingle<Luminary::Vec2d>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOption, Luminary::ConfigOptionSingle<Luminary::Vec3d>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOption, Luminary::ConfigOptionSingle<bool>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOption, Luminary::ConfigOptionSingleNullable<double>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOption, Luminary::ConfigOptionSingleNullable<int>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOption, Luminary::ConfigOptionSingleNullable<bool>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOption, Luminary::ConfigOptionVectorBase)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVectorBase, Luminary::ConfigOptionVector<double>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVectorBase, Luminary::ConfigOptionVector<int>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVectorBase, Luminary::ConfigOptionVector<std::string>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVectorBase, Luminary::ConfigOptionVector<Luminary::Vec2d>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVectorBase, Luminary::ConfigOptionVector<unsigned char>)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionSingle<double>, Luminary::ConfigOptionFloat)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionSingleNullable<double>, Luminary::ConfigOptionFloatNullable)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVector<double>, Luminary::ConfigOptionFloats)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVector<double>, Luminary::ConfigOptionFloatsNullable)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionSingle<int>, Luminary::ConfigOptionInt)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionSingleNullable<int>, Luminary::ConfigOptionIntNullable)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVector<int>, Luminary::ConfigOptionInts)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVector<int>, Luminary::ConfigOptionIntsNullable)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionSingle<std::string>, Luminary::ConfigOptionString)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVector<std::string>, Luminary::ConfigOptionStrings)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionFloat, Luminary::ConfigOptionPercent)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionFloats, Luminary::ConfigOptionPercents)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionFloats, Luminary::ConfigOptionPercentsNullable)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionPercent, Luminary::ConfigOptionFloatOrPercent)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVector<Luminary::FloatOrPercent>,
                                     Luminary::ConfigOptionFloatsOrPercents)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVector<Luminary::FloatOrPercent>,
                                     Luminary::ConfigOptionFloatsOrPercentsNullable)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionSingle<Luminary::Vec2d>, Luminary::ConfigOptionPoint)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVector<Luminary::Vec2d>, Luminary::ConfigOptionPoints)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionSingle<Luminary::Vec3d>, Luminary::ConfigOptionPoint3)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionSingle<bool>, Luminary::ConfigOptionBool)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVector<unsigned char>, Luminary::ConfigOptionBools)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionVector<unsigned char>, Luminary::ConfigOptionBoolsNullable)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionInt, Luminary::ConfigOptionEnumGeneric)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigOptionInts, Luminary::ConfigOptionEnumsGeneric)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Luminary::ConfigBase, Luminary::DynamicConfig)
