...
#include "luminary/io/zip/miniz_extension.hpp" // IWYU pragma: keep
...
namespace Luminary::GCodeThumbnails
{
...
std::unique_ptr<CompressedImageBuffer> compress_thumbnail_jpg(const ThumbnailData &data)
{
    ...
    // The default libjpeg error handler exits the process on a compression error; no error is returned here.
