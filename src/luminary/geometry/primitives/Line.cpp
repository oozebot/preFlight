...
Linef3 transform(const Linef3 &line, const Transform3d &t)
{
    ...
    return Linef3(Vec3d(local_line(0, 0), local_line(1, 0), local_line(2, 0)),
                  Vec3d(local_line(0, 1), local_line(1, 1), local_line(2, 1)));
}
...
{
    return Luminary::Geometry::directions_parallel(this->direction(), angle);
}
...
{
    return Luminary::Geometry::directions_perpendicular(this->direction(), angle);
}
