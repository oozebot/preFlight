...
void BoundingBoxBase<PointType, APointsType>::scale(double factor)
{
    this->min *= factor;
    this->max *= factor;
}
...
template<class PointType, typename APointsType>
void BoundingBoxBase<PointType, APointsType>::merge(const PointType &point)
{
    if (this->defined)
    {
...
template<class PointType, typename APointsType>
void BoundingBoxBase<PointType, APointsType>::merge(const PointsType &points)
{
...
void BoundingBox3Base<PointType>::merge(const PointType &point)
{
    if (this->defined)
    {
        this->min = this->min.cwiseMin(point);
...
template<class PointType>
void BoundingBox3Base<PointType>::merge(const PointsType &points)
{
...
template<class PointType>
void BoundingBox3Base<PointType>::merge(const BoundingBox3Base<PointType> &bb)
{
...
template<class PointType, typename APointsType>
PointType BoundingBoxBase<PointType, APointsType>::size() const
{
...
template<class PointType>
PointType BoundingBox3Base<PointType>::size() const
{
    return this->max - this->min;
}
...
template<class PointType, typename APointsType>
double BoundingBoxBase<PointType, APointsType>::radius() const
{
    assert(this->defined);
...
template<class PointType>
double BoundingBox3Base<PointType>::radius() const
{
    return 0.5 * (this->max - this->min).template cast<double>().norm();
}
...
template<class PointType, typename APointsType>
void BoundingBoxBase<PointType, APointsType>::offset(coordf_t delta)
{
...
template<class PointType>
void BoundingBox3Base<PointType>::offset(coordf_t delta)
{
...
template<class PointType, typename APointsType>
PointType BoundingBoxBase<PointType, APointsType>::center() const
{
...
template<class PointType>
PointType BoundingBox3Base<PointType>::center() const
{
    return (this->min + this->max) / 2;
}
...
template<class PointType>
coordf_t BoundingBox3Base<PointType>::max_size() const
{
    PointType s = size();
...
void BoundingBox::align_to_grid(const coord_t cell_size)
{
    if (this->defined)
    {
        min.x() = Luminary::align_to_grid(min.x(), cell_size);
        min.y() = Luminary::align_to_grid(min.y(), cell_size);
    }
}
