...
template<class L>
inline double distance_to_squared(const L &line, const Vec<Dim<L>, Scalar<L>> &point,
...
{
template<>
struct geometry_concept<Luminary::Line>
{
    typedef segment_concept type;
};

template<>
struct segment_traits<Luminary::Line>
{
    typedef coord_t coordinate_type;
    typedef Luminary::Point point_type;

    static inline point_type get(const Luminary::Line &line, direction_1d dir)
    {
