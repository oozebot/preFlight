...
inline Vec2d vertex_point(const VD::vertex_type &v)
{
...
std::vector<Vec2d> edge_offset_contour_intersections(const VD &vd, const Lines &lines,
                                                     const std::vector<double> &distances, double offset_distance);
...
Polygons offset(const Geometry::VoronoiDiagram &vd, const Lines &lines,
                const std::vector<double> &signed_vertex_distances, double offset_distance,
