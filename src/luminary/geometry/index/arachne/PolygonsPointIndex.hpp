...
// Identity function, so a templated algorithm can take either a point or something convertible to one.
 ...
 */
template<>
struct hash<Luminary::Arachne::PolygonsPointIndex>
{
    size_t operator()(const Luminary::Arachne::PolygonsPointIndex &lpi) const { return Luminary::PointHash{}(lpi.p()); }
};
} //namespace std
