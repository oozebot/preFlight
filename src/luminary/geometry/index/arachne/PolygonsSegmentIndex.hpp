...
template<>
struct geometry_concept<Luminary::Arachne::PolygonsSegmentIndex>
{
    typedef segment_concept type;
};

template<>
struct segment_traits<Luminary::Arachne::PolygonsSegmentIndex>
{
    typedef coord_t coordinate_type;
    typedef Luminary::Point point_type;

    static inline point_type get(const Luminary::Arachne::PolygonsSegmentIndex &CSegment, direction_1d dir)
    {
