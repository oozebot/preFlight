...
public:
    ...
    bool contains(const Point &point) const { return Luminary::contains(*this, point, true); }
...
{
template<>
struct geometry_concept<Luminary::Polygon>
{
    typedef polygon_concept type;
};

template<>
struct polygon_traits<Luminary::Polygon>
{
    ...
    static inline iterator_type begin_points(const Luminary::Polygon &t) { return t.points.begin(); }

    // Get the end iterator
    static inline iterator_type end_points(const Luminary::Polygon &t) { return t.points.end(); }

    // Get the number of sides of the polygon
    static inline std::size_t size(const Luminary::Polygon &t) { return t.points.size(); }

    // Get the winding direction of the polygon
    static inline winding_direction winding(const Luminary::Polygon & /* t */) { return unknown_winding; }
};

template<>
struct polygon_mutable_traits<Luminary::Polygon>
{
    // expects stl style iterators
    template<typename iT>
    static inline Luminary::Polygon &set_points(Luminary::Polygon &polygon, iT input_begin, iT input_end)
    {
        polygon.points.clear();
        while (input_begin != input_end)
        {
            polygon.points.push_back(Luminary::Point());
...
template<>
struct geometry_concept<Luminary::Polygons>
{
...
template<>
struct polygon_set_traits<Luminary::Polygons>
{
    typedef coord_t coordinate_type;
    typedef Luminary::Polygons::const_iterator iterator_type;
    typedef Luminary::Polygons operator_arg_type;

    static inline iterator_type begin(const Luminary::Polygons &polygon_set) { return polygon_set.begin(); }

    static inline iterator_type end(const Luminary::Polygons &polygon_set) { return polygon_set.end(); }

    //don't worry about these, just return false from them
    static inline bool clean(const Luminary::Polygons & /* polygon_set */) { return false; }
    static inline bool sorted(const Luminary::Polygons & /* polygon_set */) { return false; }
};

template<>
struct polygon_set_mutable_traits<Luminary::Polygons>
{
    template<typename input_iterator_type>
    static inline void set(Luminary::Polygons &polygons, input_iterator_type input_begin, input_iterator_type input_end)
    {
