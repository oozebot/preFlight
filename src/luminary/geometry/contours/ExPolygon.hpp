...
inline bool operator==(const ExPolygon &lhs, const ExPolygon &rhs)
{
...
inline Polygons to_polygons(ExPolygon &&src)
{
    ...
    polygons.insert(polygons.end(), std::make_move_iterator(src.holes.begin()),
...
inline Polygons to_polygons(ExPolygons &&src)
{
    ...
    for (ExPolygon &expoly : src)
    {
        ...
        polygons.insert(polygons.end(), std::make_move_iterator(expoly.holes.begin()),
...
inline void polygons_append(Polygons &dst, ExPolygons &&src)
{
    ...
    for (ExPolygon &expoly : src)
    {
        ...
        dst.insert(dst.end(), std::make_move_iterator(expoly.holes.begin()),
                   std::make_move_iterator(expoly.holes.end()));
    }
}
...
inline double area(const ExPolygon &poly)
{
    return poly.area();
}
...
{
template<>
struct polygon_traits<Luminary::ExPolygon>
{
    typedef coord_t coordinate_type;
    typedef Luminary::Points::const_iterator iterator_type;
    typedef Luminary::Point point_type;

    // Get the begin iterator
    static inline iterator_type begin_points(const Luminary::ExPolygon &t) { return t.contour.points.begin(); }

    // Get the end iterator
    static inline iterator_type end_points(const Luminary::ExPolygon &t) { return t.contour.points.end(); }

    // Get the number of sides of the polygon
    static inline std::size_t size(const Luminary::ExPolygon &t) { return t.contour.points.size(); }

    // Get the winding direction of the polygon
    static inline winding_direction winding(const Luminary::ExPolygon & /* t */) { return unknown_winding; }
};

template<>
struct polygon_mutable_traits<Luminary::ExPolygon>
{
    //expects stl style iterators
    template<typename iT>
    static inline Luminary::ExPolygon &set_points(Luminary::ExPolygon &expolygon, iT input_begin, iT input_end)
    {
...
template<>
struct geometry_concept<Luminary::ExPolygon>
{
    typedef polygon_with_holes_concept type;
};

template<>
struct polygon_with_holes_traits<Luminary::ExPolygon>
{
    typedef Luminary::Polygons::const_iterator iterator_holes_type;
    typedef Luminary::Polygon hole_type;
    static inline iterator_holes_type begin_holes(const Luminary::ExPolygon &t) { return t.holes.begin(); }
    static inline iterator_holes_type end_holes(const Luminary::ExPolygon &t) { return t.holes.end(); }
    static inline unsigned int size_holes(const Luminary::ExPolygon &t) { return (int) t.holes.size(); }
};

template<>
struct polygon_with_holes_mutable_traits<Luminary::ExPolygon>
{
    template<typename iT>
    static inline Luminary::ExPolygon &set_holes(Luminary::ExPolygon &t, iT inputBegin, iT inputEnd)
    {
...
template<>
struct geometry_concept<Luminary::ExPolygons>
{
...
template<>
struct polygon_set_traits<Luminary::ExPolygons>
{
    typedef coord_t coordinate_type;
    typedef Luminary::ExPolygons::const_iterator iterator_type;
    typedef Luminary::ExPolygons operator_arg_type;

    static inline iterator_type begin(const Luminary::ExPolygons &polygon_set) { return polygon_set.begin(); }

    static inline iterator_type end(const Luminary::ExPolygons &polygon_set) { return polygon_set.end(); }

    //don't worry about these, just return false from them
    static inline bool clean(const Luminary::ExPolygons & /* polygon_set */) { return false; }
    static inline bool sorted(const Luminary::ExPolygons & /* polygon_set */) { return false; }
};

template<>
struct polygon_set_mutable_traits<Luminary::ExPolygons>
{
    template<typename input_iterator_type>
    static inline void set(Luminary::ExPolygons &expolygons, input_iterator_type input_begin,
