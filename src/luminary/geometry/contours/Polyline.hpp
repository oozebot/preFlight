...
public:
    ...
    void append(const Polyline &src) { points.insert(points.end(), src.points.begin(), src.points.end()); }
...
inline bool operator==(const Polyline &lhs, const Polyline &rhs)
{
...
struct ThickPolyline
{
    ...
    double length() const { return Luminary::length(this->points); }
