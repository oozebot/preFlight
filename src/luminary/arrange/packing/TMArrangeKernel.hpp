...
#include <luminary/arrange/packing/KernelUtils.hpp>

#include <boost/geometry/index/rtree.hpp>
#include <luminary/geometry/adapters/boost/BoostAdapter.hpp>
...
public:
    ...
    TMArrangeKernel(Vec2crd gravity_center, size_t itm_cnt, double bedarea = NaNd)
        : m_bin_area(bedarea), m_item_cnt{itm_cnt}, sink{gravity_center}
    {
    }
