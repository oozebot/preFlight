...
private:
    ...
    // Settings and their defaults are stored separately for fff and fff sequential mode
    Slot m_settings_fff, m_settings_fff_seq;
    ...
    template<class Self>
    static auto &get_ref(Self *self)
    {
        return get_slot(self).vals;
    }
