...
void ArrangeSettingsDb_AppCfg::sync()
{
    ...
    auto geom_handl =
        ArrangeSettingsView::to_geometry_handling(geom_handling_str).value_or(m_settings_fff.defaults.geom_handling);

    m_settings_fff.vals.geom_handling = geom_handl;
    m_settings_fff_seq.vals.geom_handling = geom_handl;

    auto arr_strategy =
        ArrangeSettingsView::to_arrange_strategy(strategy_str).value_or(m_settings_fff.defaults.arr_strategy);
