...
// Approximate clearance envelopes for a 250x210 bed, boxes rather than measured toolhead outlines.
const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_NOZZLE_LEVEL_MK3S = {
    {{-500000, -500000}, {500000, -500000}, {500000, 500000}, {-500000, 500000}}};

const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_EXTRUDER_LEVEL_MK3S = {
    {{-2000000, -10000000}, {2000000, -10000000}, {2000000, 2000000}, {-2000000, 2000000}}};

const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_HOSE_LEVEL_MK3S = {
    {{-1000000, 500000}, {1000000, 500000}, {1000000, -250000000}, {-1000000, -250000000}}};

const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_GANTRY_LEVEL_MK3S = {
    {{-250000000, 2000000}, {250000000, 2000000}, {250000000, 2100000}, {-250000000, 2100000}}};

const std::vector<std::vector<Luminary::Polygon>> SEQ_UNREACHABLE_POLYGON_ALL_LEVELS_MK3S = {
    SEQ_UNREACHABLE_POLYGON_NOZZLE_LEVEL_MK3S, SEQ_UNREACHABLE_POLYGON_EXTRUDER_LEVEL_MK3S,
    SEQ_UNREACHABLE_POLYGON_HOSE_LEVEL_MK3S, SEQ_UNREACHABLE_POLYGON_GANTRY_LEVEL_MK3S};

const std::vector<std::vector<Luminary::Polygon>> SEQ_UNREACHABLE_POLYGON_CONVEX_LEVELS_MK3S = {
    SEQ_UNREACHABLE_POLYGON_NOZZLE_LEVEL_MK3S, SEQ_UNREACHABLE_POLYGON_EXTRUDER_LEVEL_MK3S};

const std::vector<std::vector<Luminary::Polygon>> SEQ_UNREACHABLE_POLYGON_BOX_LEVELS_MK3S = {
    SEQ_UNREACHABLE_POLYGON_HOSE_LEVEL_MK3S, SEQ_UNREACHABLE_POLYGON_GANTRY_LEVEL_MK3S};

/*----------------------------------------------------------------*/

// Nozzle height range: 0.00mm-4.9mm
const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_NOZZLE_LEVEL_MK4 = {{
    /* hand tailored */
    {-5000000, -5000000},
    {5000000, -5000000},
    {5000000, 5000000},
...
const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_EXTRUDER_LEVEL_MK4 = {{
                                                                                       /* fan - hand tailored */
                                                                                       {-10000000, -21000000},
                                                                                       {37000000, -21000000},
                                                                                       {37000000, 44000000},
...
const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_GANTRY_LEVEL_MK4 = {{
    /* hand tailored */
    {-350000000, -4000000},
    {350000000, -4000000},
    {350000000, -14000000},
...
const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_HOSE_LEVEL_MK4 = {{
...
const std::vector<std::vector<Luminary::Polygon>> SEQ_UNREACHABLE_POLYGON_ALL_LEVELS_MK4 = {
    SEQ_UNREACHABLE_POLYGON_NOZZLE_LEVEL_MK4, SEQ_UNREACHABLE_POLYGON_EXTRUDER_LEVEL_MK4,
    SEQ_UNREACHABLE_POLYGON_GANTRY_LEVEL_MK4, SEQ_UNREACHABLE_POLYGON_HOSE_LEVEL_MK4};

const std::vector<std::vector<Luminary::Polygon>> SEQ_UNREACHABLE_POLYGON_CONVEX_LEVELS_MK4 = {
    SEQ_UNREACHABLE_POLYGON_NOZZLE_LEVEL_MK4, SEQ_UNREACHABLE_POLYGON_EXTRUDER_LEVEL_MK4};

const std::vector<std::vector<Luminary::Polygon>> SEQ_UNREACHABLE_POLYGON_BOX_LEVELS_MK4 = {
    SEQ_UNREACHABLE_POLYGON_HOSE_LEVEL_MK4, SEQ_UNREACHABLE_POLYGON_GANTRY_LEVEL_MK4};

/*----------------------------------------------------------------*/

// Approximate clearance envelopes for a 360x360 bed, boxes rather than measured toolhead outlines.
const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_NOZZLE_LEVEL_XL = {
    {{-500000, -500000}, {500000, -500000}, {500000, 500000}, {-500000, 500000}}};

const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_EXTRUDER_LEVEL_XL = {
    {{-2000000, -10000000}, {2000000, -10000000}, {2000000, 2000000}, {-2000000, 2000000}}};

const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_HOSE_LEVEL_XL = {
    {{-1000000, 500000}, {1000000, 500000}, {1000000, -250000000}, {-1000000, -250000000}}};

const std::vector<Luminary::Polygon> SEQ_UNREACHABLE_POLYGON_GANTRY_LEVEL_XL = {
    {{-250000000, 2000000}, {250000000, 2000000}, {250000000, 2100000}, {-250000000, 2100000}}};

const std::vector<std::vector<Luminary::Polygon>> SEQ_UNREACHABLE_POLYGON_ALL_LEVELS_XL = {
    SEQ_UNREACHABLE_POLYGON_NOZZLE_LEVEL_XL, SEQ_UNREACHABLE_POLYGON_EXTRUDER_LEVEL_XL,
    SEQ_UNREACHABLE_POLYGON_HOSE_LEVEL_XL, SEQ_UNREACHABLE_POLYGON_GANTRY_LEVEL_XL};

const std::vector<std::vector<Luminary::Polygon>> SEQ_UNREACHABLE_POLYGON_CONVEX_LEVELS_XL = {
    SEQ_UNREACHABLE_POLYGON_NOZZLE_LEVEL_XL, SEQ_UNREACHABLE_POLYGON_EXTRUDER_LEVEL_XL};

const std::vector<std::vector<Luminary::Polygon>> SEQ_UNREACHABLE_POLYGON_BOX_LEVELS_XL = {
    SEQ_UNREACHABLE_POLYGON_HOSE_LEVEL_XL, SEQ_UNREACHABLE_POLYGON_GANTRY_LEVEL_XL};
...
void scaleDown_PolygonForSequentialSolver(const Luminary::Polygon &polygon, Luminary::Polygon &scale_down_polygon)
{
...
void scaleDown_PolygonForSequentialSolver(coord_t scale_factor, const Luminary::Polygon &polygon,
                                          Luminary::Polygon &scale_down_polygon)
{
    for (unsigned int i = 0; i < polygon.points.size(); ++i)
    {
        scale_down_polygon.points.insert(scale_down_polygon.points.begin() + i,
                                         Point(polygon.points[i].x() / scale_factor,
                                               polygon.points[i].y() / scale_factor));
    }
...
{
    Luminary::Polygon poly = polygon;

    for (unsigned int i = 0; i < poly.points.size(); ++i)
    {
        poly.points[i] = Luminary::Point(poly.points[i].x() * scale_factor, poly.points[i].y() * scale_factor);
    }

    return poly;
}

Luminary::Polygon scaleUp_PolygonForSlicer(const Polygon &polygon, double x_pos, double y_pos)
{
    return scaleUp_PolygonForSlicer(SEQ_SLICER_SCALE_FACTOR, polygon, x_pos, y_pos);
}

Luminary::Polygon scaleUp_PolygonForSlicer(coord_t scale_factor, const Polygon &polygon, double x_pos, double y_pos)
{
    Luminary::Polygon poly = polygon;
...
{
    Luminary::Polygon scale_down_polygon = scaleDown_PolygonForSequentialSolver(scale_factor, polygon);
    Luminary::Polygon scale_up_polygon = scaleUp_PolygonForSlicer(scale_factor, scale_down_polygon);
...
Polygon transform_UpsideDown(const SolverConfiguration &solver_configuration, coord_t scale_factor,
                             const Polygon &polygon)
{
    ...
    for (unsigned int i = 0; i < poly.points.size(); ++i)
    {
        poly.points[i] = Point(poly.points[i].x(), (coord_t) ((solver_configuration.plate_bounding_box.max.y() -
...
{
    transform_UpsideDown(solver_configuration, SEQ_SLICER_SCALE_FACTOR, scaled_x_pos, scaled_y_pos, transformed_x_pos,
                         transformed_y_pos);
}
                          ...
                          coord_t &transformed_y_pos)
{
    ...
    transformed_y_pos = (solver_configuration.plate_bounding_box.max.y() -
                         solver_configuration.plate_bounding_box.min.y()) *
                            scale_factor -
                        scaled_y_pos;
}
...
void decimate_PolygonForSequentialSolver(const SolverConfiguration &solver_configuration,
                                         const Luminary::Polygon &polygon, Luminary::Polygon &decimated_polygon,
                                         bool extra_safety)
{
    double DP_tolerance = SolverConfiguration::convert_DecimationPrecision2Tolerance(
        solver_configuration.decimation_precision);
    ...
    if (decimated_polygon.points.size() >= 4)
    {
        while (true)
        {
            ...
            if (contains)
            {
                if (extra_safety)
                {
                    Luminary::Polygon prefinal_polygon = decimated_polygon;

                    while (true)
                    {
                        grow_PolygonForContainedness(center_x, center_y, decimated_polygon);
                        Luminary::Polygon truncated_polygon =
                            truncate_PolygonAsSeenBySequentialSolver(SEQ_SLICER_SCALE_FACTOR, decimated_polygon);

                        bool trunc_contains = true;
                        for (unsigned int i = 0; i < prefinal_polygon.points.size(); ++i)
                        {
                            if (!Luminary::contains(truncated_polygon, prefinal_polygon.points[i], false))
                            {
                                         ...
                                         std::vector<Luminary::Polygon> &unreachable_polygons)
{
    ...
    {
        // Convert Points to Path64 for Clipper2
        Clipper2Lib::Path64 pattern, path;
        for (const auto &pt : polygon.points)
            pattern.push_back(Clipper2Lib::Point64(pt.x(), pt.y()));

        for (unsigned int i = 0; i < extruder_polygons.size(); ++i)
        {
            path.clear();
            for (const auto &pt : extruder_polygons[i].points)
                path.push_back(Clipper2Lib::Point64(pt.x(), pt.y()));

            // Clipper2 MinkowskiSum returns Paths64
            Clipper2Lib::Paths64 result = Clipper2Lib::MinkowskiSum(pattern, path, true);

            for (const auto &result_path : result)
            {
                // Convert Path64 back to Points for Polygon
                Luminary::Points pts;
                for (const auto &pt : result_path)
                    pts.emplace_back(pt.x, pt.y);
                unreachable_polygons.push_back(Polygon(pts));
            }
        }
    }
}
                                      ...
                                      std::vector<Luminary::Polygon> &unreachable_polygons)
{
    if (!polygon.points.empty())
    {
        ...
        for (unsigned int i = 0; i < extruder_polygons.size(); ++i)
        {
            ...
            unreachable_polygons.push_back(Polygon({{min_x, min_y}, {max_x, min_y}, {max_x, max_y}, {min_x, max_y}}));
        }
    }
}
                              ...
                              bool extra_safety)
{
    for (unsigned int j = 0; j < object_to_print.pgns_at_height.size(); ++j)
    {
        ...
        if (!object_to_print.pgns_at_height[j].second.points.empty())
        {
            ...
            {
                decimate_PolygonForSequentialSolver(solver_configuration, object_to_print.pgns_at_height[j].second,
                                                    decimated_polygon, extra_safety);
            }
            else
            {
            ...
            {
                std::map<coord_t, std::vector<Polygon>>::const_iterator extruder_slice =
                    printer_geometry.extruder_slices.find(height);
...
{
    prepare_UnreachableZonePolygons(solver_configuration, convex_level_polygons, box_level_polygons,
                                    extruder_convex_level_polygons, extruder_box_level_polygons, unreachable_polygons);

    assert(convex_level_polygons.size() >= 1);
    Polygon raw_polygon = convex_level_polygons[0];

    scaleDown_PolygonForSequentialSolver(raw_polygon, object_polygon);
...
void prepare_UnreachableZonePolygons(const SolverConfiguration &solver_configuration, const Luminary::Polygon &polygon,
                                     ...
                                     std::vector<Luminary::Polygon> &unreachable_polygons)
{
    std::vector<std::vector<Luminary::Polygon>> scaled_unreachable_polygons;

    for (unsigned int i = 0; i < extruder_convex_level_polygons.size(); ++i)
    {
        std::vector<Luminary::Polygon> scaled_level_unreachable_polygons;
        extend_PolygonConvexUnreachableZone(solver_configuration, polygon, extruder_convex_level_polygons[i],
    ...
    {
        std::vector<Luminary::Polygon> scaled_level_unreachable_polygons;
        extend_PolygonBoxUnreachableZone(solver_configuration, polygon, extruder_box_level_polygons[i],
                                         scaled_level_unreachable_polygons);
        scaled_unreachable_polygons.push_back(scaled_level_unreachable_polygons);
    }
    ...
    for (unsigned int i = 0; i < scaled_unreachable_polygons.size(); ++i)
    {
        for (unsigned int j = 0; j < scaled_unreachable_polygons[i].size(); ++j)
        {
            ...
            scaleDown_PolygonForSequentialSolver(scaled_unreachable_polygons[i][j], scale_down_polygon);
            scale_down_polygon.make_counter_clockwise();
                                     ...
                                     std::vector<Luminary::Polygon> &unreachable_polygons)
{
    ...
    {
        std::vector<Luminary::Polygon> scaled_level_unreachable_polygons;
        extend_PolygonConvexUnreachableZone(solver_configuration, convex_level_polygons[i],
                                            extruder_convex_level_polygons[i], scaled_level_unreachable_polygons);
        scaled_unreachable_polygons.push_back(scaled_level_unreachable_polygons);
    }
    ...
    {
        std::vector<Luminary::Polygon> scaled_level_unreachable_polygons;
        extend_PolygonBoxUnreachableZone(solver_configuration, box_level_polygons[i], extruder_box_level_polygons[i],
                                         scaled_level_unreachable_polygons);
        scaled_unreachable_polygons.push_back(scaled_level_unreachable_polygons);
    }
    scaled_unreachable_polygons = simplify_UnreachableZonePolygons(scaled_unreachable_polygons);
...
bool check_PolygonSizeFitToPlate(const SolverConfiguration &solver_configuration, const Luminary::Polygon &polygon)
{
    ...
    if (solver_configuration.plate_bounding_polygon.points.size() == 0)
    {
        ...
        if (x_size >
            (solver_configuration.plate_bounding_box.max.x() - solver_configuration.plate_bounding_box.min.x()))
        {
            return false;
        }
                                      ...
                                      const Luminary::Polygon &polygon)
{
    ...
    if (solver_configuration.plate_bounding_polygon.points.size() == 0)
    {
        if (x + polygon_box.min.x() < solver_configuration.plate_bounding_box.min.x() ||
            x + polygon_box.max.x() > solver_configuration.plate_bounding_box.max.x())
        {
            return false;
        }
        if (y + polygon_box.min.y() < solver_configuration.plate_bounding_box.min.y() ||
            y + polygon_box.max.y() > solver_configuration.plate_bounding_box.max.y())
        {
            return false;
        }
    }
    ...
    {
        if (contains(solver_configuration.plate_bounding_polygon,
                     Point(x + polygon_box.min.x(), y + polygon_box.min.y())) &&
            contains(solver_configuration.plate_bounding_polygon,
                     Point(x + polygon_box.max.x(), y + polygon_box.min.y())) &&
            contains(solver_configuration.plate_bounding_polygon,
                     Point(x + polygon_box.max.x(), y + polygon_box.max.y())) &&
            contains(solver_configuration.plate_bounding_polygon,
                     Point(x + polygon_box.min.x(), y + polygon_box.max.y())))
        {
            return true;
        }
        else
                                      ...
                                      coord_t y, const Luminary::Polygon &polygon)
{
...
#ifdef DEBUG
    {
        ...
        printf("X: %d\n",
               (solver_configuration.plate_bounding_box.max.x() - solver_configuration.plate_bounding_box.min.x()) *
                   scale_factor);
        printf("Y: %d\n",
               (solver_configuration.plate_bounding_box.max.y() - solver_configuration.plate_bounding_box.min.x()) *
                   scale_factor);
    }
#endif
    ...
    if (solver_configuration.plate_bounding_polygon.points.size() == 0)
    {
        if (x + polygon_box.min.x() < solver_configuration.plate_bounding_box.min.x() * scale_factor ||
            x + polygon_box.max.x() > solver_configuration.plate_bounding_box.max.x() * scale_factor)
        {
            return false;
        }
        if (y + polygon_box.min.y() < solver_configuration.plate_bounding_box.min.y() * scale_factor ||
            y + polygon_box.max.y() > solver_configuration.plate_bounding_box.max.y() * scale_factor)
        {
            return false;
        }
    }
...
{
    std::vector<Luminary::Polygon> polygons_to_clip;
    std::vector<Luminary::Polygon> next_polygons_to_clip;
...
{
    std::vector<std::vector<Luminary::Polygon>> simplified_unreachable_polygons;
...
void glue_LowObjects(std::vector<SolvableObject> &solvable_objects)
{
    ...
    for (unsigned int i = 0; i < solvable_objects.size(); ++i)
    {
        ...
        double unreachable_area = calc_PolygonUnreachableZoneArea(solvable_objects[i].polygon,
                                                                  solvable_objects[i].unreachable_polygons);
