...
#include <cassert>
#include <algorithm>
// std::accumulate, which the highest-occupied-bed scan uses. It arrived through the precompiled
// header while this file sat in the retiring engine; Luminary uses none.
#include <numeric>
...
Vec2d MultipleBeds::bed_gap() const
{
    ...
    // Changing this value breaks the loading of existing projects.
