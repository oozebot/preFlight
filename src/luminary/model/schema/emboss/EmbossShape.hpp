...
struct EmbossProjection
{
    ...
    // User should see and modify mainly world size not local
...
struct EmbossShape
{
    ...
    std::optional<Luminary::Transform3d> fix_3mf_tr;
...
{
template<class Archive>
void serialize(Archive &ar, Luminary::ExPolygonsWithId &o)
{
    ar(o.id, o.expoly, o.is_healed);
}
template<class Archive>
void serialize(Archive &ar, Luminary::HealedExPolygons &o)
{
