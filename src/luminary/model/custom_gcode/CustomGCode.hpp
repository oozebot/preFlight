...
///|/ Copyright (c) Prusa Research 2016 - 2023 Oleksandra Iushchenko @YuSanka, Vojtěch Bubník @bubnikv, Lukáš Matěna @lukasmatena, Pavel Mikuš @Godrak, Lukáš Hejl @hejllukas, Filip Sykala @Jony01, Enrico Turri @enricoturri1966, David Kocík @kocikdav
///|/
...
struct Info
{
    ...
    bool operator==(const Info &rhs) const
    {
        ...
        return (rhs.mode == this->mode) && (rhs.gcodes == this->gcodes);
    }
