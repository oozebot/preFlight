...
struct specialize<Archive, Luminary::TriangleMesh, cereal::specialization::non_member_load_save>
{
};
template<class Archive>
void load(Archive &archive, Luminary::TriangleMesh &mesh)
{
    archive.loadBinary(reinterpret_cast<char *>(const_cast<Luminary::TriangleMeshStats *>(&mesh.stats())),
                       sizeof(Luminary::TriangleMeshStats));
    archive(mesh.its.indices, mesh.its.vertices);
}
template<class Archive>
void save(Archive &archive, const Luminary::TriangleMesh &mesh)
{
    archive.saveBinary(reinterpret_cast<const char *>(&mesh.stats()), sizeof(Luminary::TriangleMeshStats));
    archive(mesh.its.indices, mesh.its.vertices);
}
} // namespace cereal
