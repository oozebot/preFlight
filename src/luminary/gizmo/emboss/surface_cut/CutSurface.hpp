...
#include "luminary/gizmo/emboss/Emboss.hpp" // IProjection
...
SurfaceCut cut_surface(const ExPolygons &shapes, const std::vector<indexed_triangle_set> &models,
...
/// Only 2d filtration, do not filtrate by Z coordinate
/// </summary>
...
indexed_triangle_set its_cut_AoI(const indexed_triangle_set &its, const BoundingBox &bb,
