...
#include "luminary/gizmo/emboss/Emboss.hpp" // heal for shape
...
namespace
{
using namespace Luminary; // Polygon
...
{
    // nsvg parser consume data from input(char *)
...
namespace
{
using namespace Luminary; // Polygon + Vec2f
