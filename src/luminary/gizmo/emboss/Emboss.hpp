...
#include "luminary/model/schema/emboss/EmbossShape.hpp" // ExPolygonsWithIds
...
struct Glyph
{
    // shape is scaled by SHAPE_SCALE
...
struct FontFileWithCache
{
    ...
    // Accessible only in the plater job thread. The main thread only clears the cache, by setting
    // another shared_ptr.
...
/// </summary>
/// <param name="is_non_zero">Fill type FillRule::NonZero for overlapping otherwise </param>
...
/// <summary>
/// call Luminary::union_ex before this call
///
...
/// </summary>
/// <param name="slice">Polygon and start point [scaled millimetres]</param>
...
// remove unprintable spaces between neighbor curves (made by linearization of curve)
