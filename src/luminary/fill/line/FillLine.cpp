...
void FillLine::_fill_surface_single(const FillParams &params, unsigned int thickness_layers,
                                    ...
                                    Polylines &polylines_out)
{
    ...
    else
    {
        ...
        bounding_box.merge(align_to_grid(bounding_box.min, Point(this->_line_spacing, this->_line_spacing),
    ...
    // The overlap below is applied along the line direction only, at both ends of each line.
