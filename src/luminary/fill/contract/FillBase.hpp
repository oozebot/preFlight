...
class InfillFailedException : public Luminary::RuntimeError
{
public:
    InfillFailedException() : Luminary::RuntimeError("Infill failed") {}
};
...
public:
    ...
    void set_bounding_box(const Luminary::BoundingBox &bbox) { bounding_box = bbox; }
...
// Runtime category-gated debug output (Luminary::dbg_log) lives in DebugOutput.hpp,
// included above.
