...
public:
     ...
     */
    explicit Generator(const PrintObject &print_object, const coordf_t fill_density,
                       const std::function<void()> &throw_on_cancel_callback);

    /*!
     * Create a generator over caller-supplied outlines instead of a PrintObject.
     *
