...
std::error_code rename(const std::string &from, const std::string &to)
{
    ...
    // The most likely cause of reaching here.
                     ...
                     boost::system::error_code &ec)
{
    ...
    // copy_file implementation that uses a sendfile loop; needs Linux 2.6.33 or newer.
    // copy_file_range is not used.
    {
...
CopyFileResult copy_file_inner(const std::string &from, const std::string &to, std::string &error_message)
{
    ...
    // error_code variants are used here to supress expception throwing.
