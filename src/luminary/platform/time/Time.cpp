...
{
// Own get_time and put_time, used instead of the standard ones on every platform.
...
static const std::map<std::string, std::string> sscanf_fmt_map = {{SLICER_UTC_TIME_FMT,
