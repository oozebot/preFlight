    ...
    for (GList *l = cookies; l != nullptr; l = l->next)
    {
        ...
        */
        webkit_cookie_manager_delete_cookie(cookie_manager, cookie, nullptr,
                                            (GAsyncReadyCallback) Slic3r::GUI::delete_cookie_callback, nullptr);
...
void delete_cookies(wxWebView *web_view, const std::string &url)
{
    ...
    webkit_cookie_manager_get_cookies(cookieManager, uri, nullptr,
                                      (GAsyncReadyCallback) Slic3r::GUI::get_cookie_callback, nullptr);
}
