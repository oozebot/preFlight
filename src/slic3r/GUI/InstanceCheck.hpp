...
public:
    ...
    {
        m_message_handlers["CLI"] = std::bind(&OtherInstanceMessageHandler::handle_message_type_cli, this,
                                              std::placeholders::_1);
        m_message_handlers["STORE_READ"] = std::bind(&OtherInstanceMessageHandler::handle_message_type_store_read, this,
                                                     std::placeholders::_1);
    }
...
#endif //WIN32
private:
    //finds paths to models in message(= command line arguments, first should be preFlight executable)
    ...
    //						mac - anybody who posts notification with name:@"OtherpreFlightTerminating"
