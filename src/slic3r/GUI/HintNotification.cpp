            ...
            if (dict.find("hypertext_type") != dict.end())
            {
                ...
                if (dict["hypertext_type"] == "link")
                {
                    ...
                    HintData hint_data{id_string,
                                       ...
                                       [hypertext_link]()
                                       {
                                           launch_browser_if_allowed(hypertext_link);
                                       }};
                ...
                else if (dict["hypertext_type"] == "settings")
                {
                    ...
                    HintData hint_data{id_string,
                                       ...
                                       [opt, type, category]()
                                       {
                                           GUI::wxGetApp().jump_to_option(opt, type, category);
                                       }};
                    m_loaded_hints.emplace_back(hint_data);
                    // open preferences
                }
                else if (dict["hypertext_type"] == "preferences")
                {
                    ...
                    HintData hint_data{id_string,
                                       ...
                                       [page, item]()
                                       {
                                           wxGetApp().open_preferences(item, page);
                                       }};
                    m_loaded_hints.emplace_back(hint_data);
                }
                ...
                else if (dict["hypertext_type"] == "menubar")
                {
                    ...
                    HintData hint_data{id_string,
                                       ...
                                       [menu, item]()
                                       {
                                           wxGetApp().mainframe->open_menubar_item(menu, item);
                                       }};
                    m_loaded_hints.emplace_back(hint_data);
                }
            }
