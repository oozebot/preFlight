...
public:
    ...
    {
        can_create_editor_ctrl = can_create_fn;
    }
...
public:
    ...
    void set_default_extruder_idx(std::function<int()> default_extruder_idx_fn)
    {
        get_default_extruder_idx = default_extruder_idx_fn;
    }
