...
class ModeSizer;
class CheckBox; // Global namespace CheckBox widget
class Slider;   // Custom Slider widget with orange theme
...
class Sidebar : public wxPanel
{
    ...
    ScalableButton *m_btn_export_gcode_removable{
        nullptr}; //exports to removable drives (appears only if removable drive is connected)
                  //
