...
class Mouse3DController
{
    ...
    struct Params
    {
        ...
        static constexpr double DefaultTranslationScale = 8.0; // Increased from 2.5 to 8.0 (3.2x faster)
        static constexpr double MaxTranslationDeadzone = 0.2;
        static constexpr double DefaultTranslationDeadzone = 0.0;
        static constexpr float DefaultRotationScale = 1.5f; // Increased from 1.0 to 1.5 (50% faster)
        static constexpr float MaxRotationDeadzone = 0.2f;
        static constexpr float DefaultRotationDeadzone = 0.0f;
        static constexpr double DefaultZoomScale = 0.3; // Increased from 0.1 to 0.3 (3x faster)
...
private:
    ...
    static bool handle_input(const DataPacketRaw &packet, const int packet_length, const Params &params,
                             State &state_in_out);
    // The following is called by handle_input() from the worker thread.
    static bool handle_packet(const DataPacketRaw &packet, const int packet_length, const Params &params,
                              State &state_in_out);
    static bool handle_packet_translation(const DataPacketRaw &packet, const Params &params, State &state_in_out);
    static bool handle_packet_rotation(const DataPacketRaw &packet, unsigned int first_byte, const Params &params,
                                       State &state_in_out);
    static bool handle_packet_button(const DataPacketRaw &packet, unsigned int packet_size, const Params &params,
                                     State &state_in_out);
#endif /* __APPLE__ */
};
