...
class TopBarItemsCtrl : public wxControl
{
    ...
    public:
        Button() {};
        Button(wxWindow *parent, const wxString &label, const std::string &icon_name = "", const int px_cnt = 16,
    ...
    public:
        ButtonWithPopup() {};
        ButtonWithPopup(wxWindow *parent, const wxString &label, const std::string &icon_name = "",
                        const int px_cnt = 16, wxSize size = wxDefaultSize);
...
{
public:
    TopBar(wxWindow *parent, wxWindowID winid = wxID_ANY, const wxPoint &pos = wxDefaultPosition,
    ...
    bool Create(wxWindow *parent, wxWindowID winid = wxID_ANY, const wxPoint &pos = wxDefaultPosition,
                const wxSize &size = wxDefaultSize, long style = 0, TopBarMenus *menus = nullptr,
                std::function<void()> cb_settings_btn = nullptr)
    {
        ...
        this->Bind(wxCUSTOMEVT_TOPBAR_SEL_CHANGED,
    ...
    bool ShowNewPage(wxWindow *page) { return AddNewPage(page, wxString(), "" /*true */ /* select it */); }
    ...
    bool InsertNewPage(size_t n, wxWindow *page, const wxString &text, const std::string &bmp_name = "",
                       bool bSelect = false)
    {
    ...
    // Page management
    bool InsertPage(size_t n, wxWindow *page, const wxString &text, bool bSelect = false,
    ...
    void UpdateMode() { GetTopBarItemsCtrl()->UpdateMode(); }

    void ShowUserAccount(bool show) { GetTopBarItemsCtrl()->ShowUserAccount(show); }

    void Rescale() { GetTopBarItemsCtrl()->Rescale(); }

    void OnColorsChanged() { GetTopBarItemsCtrl()->OnColorsChanged(); }

    void UpdateModeMarkers() { GetTopBarItemsCtrl()->UpdateModeMarkers(); }
    ...
    void SetSettingsButtonTooltip(const wxString &tooltip) { GetTopBarItemsCtrl()->SetSettingsButtonTooltip(tooltip); }

    void UpdateSearchSizeAndPosition() { GetTopBarItemsCtrl()->UpdateSearchSizeAndPosition(); }

    void UpdateSearch(const wxString &search) { GetTopBarItemsCtrl()->UpdateSearch(search); }
