...
static const int clr_border_hovered = 0xEAA032;  //0x00AE42;
...
static const int clr_background_focused = 0xEAA032;        //0xEDFAF2;
...
static const int clr_foreground_disabled_dark = 0x808080;  // Lighter gray visible on dark background
static const int clr_foreground_disabled_light = 0x909090; // Original gray for light mode
