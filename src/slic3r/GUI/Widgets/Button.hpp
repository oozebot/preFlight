...
public:
    ...
    Button(wxWindow *parent, wxString text, wxString icon = "", long style = 0, wxSize iconSize = wxDefaultSize);

    bool Create(wxWindow *parent, wxString text, wxString icon = "", long style = 0, wxSize iconSize = wxDefaultSize);
