...
StateColor::StateColor(wxColour const &color)
{
    append(color, 0);
}

StateColor::StateColor(wxString const &color)
{
    append(color, 0);
}

StateColor::StateColor(unsigned long color)
{
    append(color, 0);
}
...
void StateColor::setTakeFocusedAsHovered(bool set)
{
    takeFocusedAsHovered_ = set;
}
