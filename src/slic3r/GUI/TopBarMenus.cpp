...
wxString TopBarMenus::get_workspace_name(int mode /* = -1*/)
{
    ...
    return mode == Slic3r::ConfigOptionMode::comSimple     ? _L("Beginner mode")
           : mode == Slic3r::ConfigOptionMode::comAdvanced ? _L("Normal mode")
                                                           : _L("Expert mode");
}
...
void TopBarMenus::ApplyWorkspacesMenu()
{
    ...
    for (const Slic3r::ConfigOptionMode &mode :
         {Slic3r::ConfigOptionMode::comSimple, Slic3r::ConfigOptionMode::comAdvanced,
