...
public:
    ...
    std::shared_ptr<ArchiveViewNode> AddFile(std::shared_ptr<ArchiveViewNode> parent, const wxString &name,
                                             bool container);
...
{
public:
    FileArchiveDialog(wxWindow *parent_window, mz_zip_archive *archive,
