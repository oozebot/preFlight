...
void MainFrame::show_printer_webview_content()
{
    ...
    // preFlight: navigating to the printer web view closes the search dialog if it is open
...
// preFlight: a native preFlight config bundle starts with a "# generated by preFlight ..." header
// (see header_slic3r_generated()). Any bundle without that header (SuperSlicer, PrusaSlicer, OrcaSlicer,
// hand-edited, etc.) is treated as external so the user can be warned it may not map 1:1 onto preFlight.
...
void MainFrame::load_configbundle(wxString file /* = wxEmptyString, const bool reset_user_profile*/)
{
    ...
    // preFlight: warn that an external bundle is not guaranteed to be a 1:1 match with preFlight. Shown before
