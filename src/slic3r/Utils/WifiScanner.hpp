...
private:
    ...
    using WlanQueryInterfaceFunc = DWORD(WINAPI *)(HANDLE, const GUID *, WLAN_INTF_OPCODE, PVOID, PDWORD, PVOID *,
    ...
    using WlanGetAvailableNetworkListFunc = DWORD(WINAPI *)(HANDLE, const GUID *, DWORD, PVOID,
