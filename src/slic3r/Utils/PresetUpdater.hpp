...
public:
    ...
    void sync_blocking(const VendorMap &vendors, const SharedArchiveRepositoryVector &repositories,
    ...
    UpdateResult config_update(const Semver &old_slic3r_version, UpdateParams params,
    ...
    bool install_bundles_rsrc_or_cache_vendor(std::vector<std::string> bundles,
                                              const SharedArchiveRepositoryVector &repositories,
