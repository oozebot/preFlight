...
#ifndef ARACHNE_DISTRIBUTED_BEADING_STRATEGY_H
#define ARACHNE_DISTRIBUTED_BEADING_STRATEGY_H
...
public:
    ...
    */
    DistributedBeadingStrategy(coord_t optimal_width, coord_t default_transition_length, double transitioning_angle,
                               double wall_split_middle_threshold, double wall_add_middle_threshold,
...
#endif // ARACHNE_DISTRIBUTED_BEADING_STRATEGY_H
