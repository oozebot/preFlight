...
#ifndef ARACHNE_BEADING_STRATEGY_H
#define ARACHNE_BEADING_STRATEGY_H
...
public:
    ...
    BeadingStrategy(coord_t optimal_width, double wall_split_middle_threshold, double wall_add_middle_threshold,
                    coord_t default_transition_length, float transitioning_angle = pi_div(3));
...
protected:
    ...
    double
        wall_split_middle_threshold; //! Threshold when a middle wall should be split into two, as a ratio of the optimal wall width.

    double
        wall_add_middle_threshold; //! Threshold when a new middle wall should be added between an even number of walls, as a ratio of the optimal wall width.
...
#endif // ARACHNE_BEADING_STRATEGY_H
