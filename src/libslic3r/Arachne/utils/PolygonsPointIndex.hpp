...
#ifndef ARACHNE_UTILS_POLYGONS_POINT_INDEX_H
#define ARACHNE_UTILS_POLYGONS_POINT_INDEX_H
...
{
    size_t operator()(const Slic3r::Arachne::PolygonsPointIndex &lpi) const { return Slic3r::PointHash{}(lpi.p()); }
};
} //namespace std
