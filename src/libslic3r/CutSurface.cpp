...
SurfaceCut Slic3r::cut_surface(const ExPolygons &shapes, const std::vector<indexed_triangle_set> &models,
...
indexed_triangle_set Slic3r::its_cut_AoI(const indexed_triangle_set &its, const BoundingBox &bb,
...
/// <param name="shape_mesh">Vertices of mesh made by shapes</param>
/// <param name="shape2index">Convert index to shape point from ExPolygons</param>
void set_face_type(FaceTypeMap &face_type_map, const CutMesh &mesh, const VertexShapeMap &vertex_shape_map,
...
void priv::set_face_type(FaceTypeMap &face_type_map, const CutMesh &mesh, const VertexShapeMap &vertex_shape_map,
                         const EdgeBoolMap &ecm, const CutMesh &shape_mesh, const ExPolygonsIndices &shape2index)
{
