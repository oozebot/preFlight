    ...
    s_platform_flavor = PlatformFlavor::GenericOSX;
    {
        ...
        if (sysctlbyname("hw.cputype", &type, &size, NULL, 0) == 0)
        {
            ...
            if (type == CPU_TYPE_X86)
            {
                ...
                // Detect if native CPU is really X86 or preFlight runs through Rosetta.
                ...
                {
                    // Native CPU is ARM and preFlight runs through Rosetta.
...
std::string platform_flavor_to_string(PlatformFlavor pf)
{
    switch (pf)
    {
    case PlatformFlavor::Uninitialized:
        return "Unitialized";
    case PlatformFlavor::Unknown:
        return "Unknown";
    case PlatformFlavor::Generic:
        return "Generic";
    case PlatformFlavor::GenericLinux:
        return "GenericLinux";
    case PlatformFlavor::LinuxOnChromium:
        return "LinuxOnChromium";
    case PlatformFlavor::WSL:
        return "WSL";
    case PlatformFlavor::WSL2:
        return "WSL2";
    case PlatformFlavor::OpenBSD:
        return "OpenBSD";
    case PlatformFlavor::GenericOSX:
        return "GenericOSX";
