...
public:
    ...
    explicit Triangulator(const std::vector<Vec<3, Sc>> *points, Ring &lower, Ring &upper)
...
void triangulate_wall(std::vector<Vec<3, Sc>> &pts, std::vector<Vec<3, I>> &ind, const Polygon &lower,
                      const Polygon &upper, double lower_z_mm, double upper_z_mm)
{
