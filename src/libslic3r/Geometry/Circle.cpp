...
Point circle_center_taubin_newton(const Points::const_iterator &input_begin, const Points::const_iterator &input_end,
                                  size_t cycles)
{
    Vec2ds tmp;
...
// lie on.
Vec2d circle_center_taubin_newton(const Vec2ds::const_iterator &input_begin, const Vec2ds::const_iterator &input_end,
                                  size_t cycles)
{
...
{
    return circle_linear_least_squares_by_solver(
        input, [](const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic /* 3 */> &A, const Eigen::VectorXd &b)
