...
#ifndef PREFLIGHT_QUADRIC_EDGE_COLLAPSE_HPP
#define PREFLIGHT_QUADRIC_EDGE_COLLAPSE_HPP
...
void its_quadric_edge_collapse(indexed_triangle_set &its, uint32_t triangle_count = 0, float *max_error = nullptr,
...
#endif // PREFLIGHT_QUADRIC_EDGE_COLLAPSE_HPP
