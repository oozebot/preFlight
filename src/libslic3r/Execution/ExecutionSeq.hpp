...
#ifdef PREFLIGHT_USE_EXECUTION_STD // Conflicts with our version of TBB
#include <execution>
#endif
...
#ifdef PREFLIGHT_USE_EXECUTION_STD
template<>
struct IsExecutionPolicy_<std::execution::sequenced_policy> : public std::true_type
{
};
template<>
struct IsSequentialEP_<std::execution::sequenced_policy> : public std::true_type
{
};
#endif
...
public:
    ...
    static T reduce(const EP &, I from, I to, const T &init, MergeFn &&mergefn, AccessFn &&access,
