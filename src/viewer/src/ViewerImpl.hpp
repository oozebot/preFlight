...
private:
    ...
    // Scene-pass uniforms of the visible segments shader
    int m_uni_segments_shadow_vp_id{-1};
    int m_uni_segments_scene_passes_id{-1};
    int m_uni_segments_shadow_tex_id{-1};
    int m_uni_segments_ao_tex_id{-1};
    int m_uni_segments_viewport_size_id{-1};
    //
    ...
    // Binds the segment texture buffers, draws the enabled segments with the
    // currently bound program, and restores the previous buffer bindings.
    void draw_enabled_segments();
