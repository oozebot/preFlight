...
void scaleDown_PolygonForSequentialSolver(const Slic3r::Polygon &polygon, Slic3r::Polygon &scale_down_polygon)
{
    scaleDown_PolygonForSequentialSolver(SEQ_SLICER_SCALE_FACTOR, polygon, scale_down_polygon);
}

void scaleDown_PolygonForSequentialSolver(coord_t scale_factor, const Slic3r::Polygon &polygon,
...
void decimate_PolygonForSequentialSolver(const SolverConfiguration &solver_configuration,
                                         const Slic3r::Polygon &polygon, Slic3r::Polygon &decimated_polygon,
                                         bool extra_safety)
{
...
void decimate_PolygonForSequentialSolver(double DP_tolerance, const Slic3r::Polygon &polygon,
                                         Slic3r::Polygon &decimated_polygon, bool extra_safety)
{
        ...
        while (true)
        {
            ...
            if (contains)
            {
                if (extra_safety)
                {
                    ...
                    {
                        grow_PolygonForContainedness(center_x, center_y, decimated_polygon);
                        Slic3r::Polygon truncated_polygon =
...
void prepare_ExtruderPolygons(const SolverConfiguration &solver_configuration, const PrinterGeometry &printer_geometry,
                              const ObjectToPrint &object_to_print, std::vector<Slic3r::Polygon> &convex_level_polygons,
                              std::vector<Slic3r::Polygon> &box_level_polygons,
                              std::vector<std::vector<Slic3r::Polygon>> &extruder_convex_level_polygons,
                              std::vector<std::vector<Slic3r::Polygon>> &extruder_box_level_polygons, bool extra_safety)
{
...
void prepare_ObjectPolygons(const SolverConfiguration &solver_configuration,
                            ...
                            Slic3r::Polygon &object_polygon, std::vector<Slic3r::Polygon> &unreachable_polygons)
{
...
void prepare_UnreachableZonePolygons(const SolverConfiguration &solver_configuration, const Slic3r::Polygon &polygon,
                                     const std::vector<std::vector<Slic3r::Polygon>> &extruder_convex_level_polygons,
                                     const std::vector<std::vector<Slic3r::Polygon>> &extruder_box_level_polygons,
                                     std::vector<Slic3r::Polygon> &unreachable_polygons)
{
...
bool check_PolygonPositionWithinPlate(const SolverConfiguration &solver_configuration, coord_t scale_factor, coord_t x,
                                      coord_t y, const Slic3r::Polygon &polygon)
{
    BoundingBox polygon_box = get_extents(polygon);
...
bool check_PolygonConsumation(const std::vector<Slic3r::Polygon> &polygons,
                              const std::vector<Slic3r::Polygon> &consumer_polygons)
{
...
std::vector<std::vector<Slic3r::Polygon>> simplify_UnreachableZonePolygons(
