...
{
public:
    WarningDialog(wxWindow *parent, const wxString &message, const wxString &caption = wxEmptyString,
                  long style = wxOK);
...
public:
    ...
    RichMessageDialogBase(wxWindow *parent, const wxString &message, const wxString &caption = wxEmptyString,
                          long style = wxOK);
    RichMessageDialogBase(wxWindow *parent, const HtmlContent &content, const wxString &caption = wxEmptyString,
                          long style = wxOK);
    ...
    virtual bool SetYesNoCancelLabels(const wxMD::ButtonLabel &yes, const wxMD::ButtonLabel &no,
...
public:
    StaticLine(wxWindow *parent, wxWindowID id = wxID_ANY, const wxPoint &pos = wxDefaultPosition,
        ...
        : wxTextCtrl(parent, id, wxEmptyString, pos,
                     size != wxDefaultSize ? size : (style == wxLI_HORIZONTAL ? wxSize(10, 1) : wxSize(1, 10)),
...
// Custom themed MsgDialog-based dialogs on all platforms; the native
// wxMessageDialog/wxRichMessageDialog on Linux/macOS ignore the theme.
...
public:
    ...
    MessageDialog(wxWindow *parent, const wxString &message, const wxString &caption = wxEmptyString,
                  long style = wxOK);
...
{
public:
    HtmlCapableRichMessageDialog(wxWindow *parent, const wxString &msg, const wxString &caption, long style,
...
{
public:
    InfoDialog(wxWindow *parent, const wxString &title, const wxString &msg, bool is_marked = false,
