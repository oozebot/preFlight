...
static const Luminary::ColorRGBA DEFAULT_PLANE_COLOR = {0.9f, 0.9f, 0.9f, 0.5f};
static const Luminary::ColorRGBA DEFAULT_HOVER_PLANE_COLOR = {0.9f, 0.9f, 0.9f, 0.75f};
...
void GLGizmoFlatten::update_planes()
{
    ...
    for (unsigned int polygon_id = 0; polygon_id < m_planes.size(); ++polygon_id)
    {
        ...
        polygon = Luminary::Geometry::convex_hull(polygon);
