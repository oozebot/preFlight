...
#include "DSKY/GUI/GLTexture.hpp"
#include "DSKY/GUI/GLToolbar.hpp"
#include "DSKY/GUI/Gizmos/GLGizmoBase.hpp"
...
class GLGizmosManager : public Luminary::ObjectBase
{
public:
...
private:
    bool gizmo_event(GizmoEventType action, const Vec2d &mouse_position = Vec2d::Zero(), bool shift_down = false,
...
{
template<class Archive>
struct specialize<Archive, DSKY::GLGizmosManager, cereal::specialization::member_load_save>
{
};
} // namespace cereal
