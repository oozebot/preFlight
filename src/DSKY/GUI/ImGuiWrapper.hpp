...
public:
    ...
    static ImVec2 suggest_location(const ImVec2 &dialog_size, const Luminary::Polygon &interest,
    ...
    static void draw(const Luminary::Polygon &polygon, ImDrawList *draw_list = ImGui::GetOverlayDrawList(),
