                                                     ...
                                                     unsigned int sprite_size_px, bool compress)
{
    ...
    // Theme-aware monochrome icon colors for the enabled (state 1) and disabled (state 2) variants.
    const wxColour ic_enabled = DSKY::active_palette().icon_enabled;
    const wxColour ic_disabled = DSKY::active_palette().icon_disabled;
    ...
    // Recolor the brand orange baked into the icon SVGs to the active theme accent. The colored
                              ...
                              unsigned int max_size_px)
{
    ...
    // Recolor the brand orange baked into single-texture SVGs (e.g. the toolbar hint arrow)
