...
#include "DSKY/GUI/TextLines.hpp"
...
public:
    ...
    Luminary::Emboss::TextLines text_lines = {};
...
struct DataUpdate
{
    ...
    // Add for style change, because it change rotation and distance from surface
...
public:
    ...
    /// Be carefull it doesn't care about
