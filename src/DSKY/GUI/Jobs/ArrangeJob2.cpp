...
public:
    ...
    {
        const GLVolume *volume{DSKY::get_selected_gl_volume(*m_sel)};
...
static Luminary::Polygon get_wtpoly(const GLCanvas3D::WipeTowerInfo &wti)
{
    auto bb = scaled(wti.bounding_box());
    Luminary::Polygon poly = Luminary::Polygon(
