...
#include <luminary/arrange/scene/ArrangeItem.hpp>
...
struct ArrCtl : public arr2::ArrangeTaskBase::Ctl
{
    ...
    bool was_canceled() const override { return parent_ctl.was_canceled(); }
...
{
public:
    using ResultType = typename decltype(std::declval<ArrangeTaskT>().process_native(
...
public:
    ...
    explicit ArrangeJob_(arr2::Scene &&scene, std::string task_msg, const Callbacks &cbs = {})
