...
#include <optional>
#include "luminary/geometry/primitives/Point.hpp" // Vec2d, Transform3d
#include "DSKY/Utils/RaycastManager.hpp"
#include "DSKY/GUI/InputEvents.hpp"
#include <functional>
...
/// Dragged volume has to be selected. And also has to be hovered on start of dragging.
/// </summary>
...
/// Get transformation to world
/// - use fix after store to 3mf when exists
/// when not one volume selected return identity
/// </summary>
