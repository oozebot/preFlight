...
public:
    ...
    void SetMirrored(bool mirrored) { m_draw_opts.mirrored = mirrored; }
    bool IsMirrored() const { return m_draw_opts.mirrored; }
...
private:
    struct DrawOptions
    {
        ...
        // Vertical slider laid out for the left edge: groove on the inner side, labels hanging to the right.
        bool mirrored{false};
