...
#include "DSKY/Utils/TD1SSensor.hpp"
...
private:
    ...
    wxTimer *m_version_check_timer{nullptr}; // periodic version check (every 4 hours)
    std::string m_version_last_notified;     // prevents repeat notifications for same version
    bool m_startup_update_shown{false};      // first update-available check shows full dialog
