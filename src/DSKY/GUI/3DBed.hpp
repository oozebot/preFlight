...
public:
    ...
    // Draws only the bed surface triangles with whatever shader is bound; used by
    // the Full lighting tier as the shadow/AO catcher and G-buffer contribution.
    void render_shadow_catcher_geometry();
...
private:
    ...
    void render_texture(bool bottom, GLCanvas3D &canvas, const Transform3d &view_matrix,
    ...
    void render_default(bool bottom, bool picking, bool show_texture, const Transform3d &view_matrix,
    ...
    void render_logo(GLCanvas3D &canvas, const Transform3d &view_matrix, const Transform3d &projection_matrix);
