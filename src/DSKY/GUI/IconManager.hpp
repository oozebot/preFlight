...
#include "DSKY/GUI/GLTexture.hpp" // texture storage
...
public:
    ...
    /// Have to be called after OpenGL initialization
    /// </summary>
...
void draw(const IconManager::Icon &icon, const ImVec2 &size = ImVec2(0, 0), const ImVec4 &tint_col = ImVec4(1, 1, 1, 1),
