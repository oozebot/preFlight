...
#include "luminary/gizmo/raycast/AABBMesh.hpp"
#include "luminary/gizmo/csg/TriangleMeshAdapter.hpp"
#include "luminary/gizmo/csg/CSGMeshCopy.hpp"
...
public:
    ...
    {
        return m_data[0] == cp.m_data[0] && m_data[1] == cp.m_data[1] && m_data[2] == cp.m_data[2] &&
    ...
    {
        // The normal is not guaranteed to be unit length here.
...
public:
    ...
    bool unproject_on_mesh(
        ...
        bool require_even_number_of_hits =
            true // When it is true, then an odd number (unclipped) of hits are ignored, and false is returned.
    ) const;
