...
class RepositoryUpdateUIManager
{
    struct OnlineEntry
    {
        OnlineEntry(bool use, const std::string &id, const std::string &name, const std::string &description,
                    const std::string &visibility, bool not_in_manifest)
            : use(use)
            , id(id)
            , name(name)
    ...
    struct OfflineEntry
    {
        OfflineEntry(bool use, const std::string &id, const std::string &name, const std::string &description,
                     const std::string &source, bool is_ok, boost::filesystem::path source_path)
            : use(use)
            , id(id)
            , name(name)
            , description(description)
...
public:
    ...
    RepositoryUpdateUIManager(wxWindow *parent, Luminary::PresetUpdaterWrapper *puw, int em);
    ~RepositoryUpdateUIManager() {}
