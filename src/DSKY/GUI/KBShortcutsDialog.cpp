...
KBShortcutsDialog::KBShortcutsDialog()
    : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY,
                wxString(wxGetApp().is_editor() ? PREFLIGHT_APP_NAME : GCODEVIEWER_APP_NAME) + " - " +
...
/*    else
    ...
    // Apply theme background on Linux/macOS (UpdateDlgDarkUI is Windows-only)
...
void KBShortcutsDialog::fill_shortcuts()
{
    ...
    if (wxGetApp().is_editor())
    {
        ...
        Shortcuts plater_shortcuts = {
            ...
            {"I", L("Zoom in")},
            {"O", L("Zoom out")},
            {L("Alt+Middle mouse button"), L("Center view and orbit pivot on the point under the cursor")},
