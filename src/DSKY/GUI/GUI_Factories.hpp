...
// The per-object key taxonomy the start-up assertion compares overridable_at against
...
private:
    ...
    wxMenu m_part_menu;
    wxMenu m_text_part_menu;
    wxMenu m_svg_part_menu;
    wxMenu m_default_menu;
    wxMenu m_instance_menu;
    ...
    void append_menu_items_add_volume();
    ...
    void append_menu_items_convert_unit(
        wxMenu *menu,
        int insert_pos = 1); // Add "Conver/Revert..." menu items (from/to inches/meters) after "Reload From Disk"
