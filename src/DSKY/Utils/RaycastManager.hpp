...
#include <optional>
#include "luminary/gizmo/raycast/AABBMesh.hpp"    // Structure to cast rays
#include "luminary/geometry/primitives/Point.hpp" // Transform3d
#include "luminary/core/ObjectID.hpp"
#include "luminary/model/scene/Model.hpp" // ModelObjectPtrs, ModelObject, ModelInstance, ModelVolume
...
public:
    ...
    /// It inspect also oposit direction of ray
    /// </summary>
