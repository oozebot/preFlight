...
public:
    ...
    /// </summary>
    /// <param name="app_config">Application configuration loaded from file "preFlight.ini"
    ...
    Luminary::Emboss::FontFileWithCache &get_font_file_with_cache() { return m_style_cache.font_file; }
    ...
    bool set_wx_font(const wxFont &wx_font, std::unique_ptr<Luminary::Emboss::FontFile> font_file);
    ...
    struct Style : public EmbossStyle
    {
        ...
        {
            return EmbossStyle::operator==(other) && projection == other.projection &&
                   is_approx(distance, other.distance) && is_approx(angle, other.angle);
        }
    ...
    static float get_imgui_font_size(const FontProp &prop, const Luminary::Emboss::FontFile &file, double scale);
...
private:
    ...
    struct StyleCache
    {
        ...
        Luminary::Emboss::FontFileWithCache font_file = {};
    ...
    struct StyleImagesData
    {
        struct Item
        {
            Luminary::Emboss::FontFileWithCache font;
            std::string text;
            FontProp prop;
        };
