...
function(add_cmake_project projectname)
    ...
    # Remaining dependency requiring workaround: JPEG/libjpeg-turbo (2.8.12)
    # - NLopt updated to 2.10.0 (cmake_min 3.18) - no longer needs workaround
    # - OCCT updated to 7.8.1 (cmake_min 3.10) - no longer needs workaround
    set(_cmake4_compat_args "")
    if (CMAKE_VERSION VERSION_GREATER_EQUAL "4.0")
        set(_cmake4_compat_args "-DCMAKE_POLICY_VERSION_MINIMUM=3.5")
    endif()
    ...
    if (MSVC)
        set(_msvc_runtime_policy_args "-DCMAKE_POLICY_DEFAULT_CMP0091:STRING=NEW")
    endif()
